...
[Actions](https://book.cakephp.org/5.x/controllers.html#controller-actions) contain the logic for your API endpoint.
...
the [CakePHP documentation](https://book.cakephp.org/5.x/views/json-and-xml-views.html#creating-json-views).
