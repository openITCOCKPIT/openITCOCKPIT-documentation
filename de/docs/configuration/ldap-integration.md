...
| LDAP.QUERY       | LDAP Filter zum Filtern von Benutzern, **ohne deaktivierte** Benutzer                                                         | `(&(objectClass=user)(sAMAccountType=805306368)(objectCategory=person)(cn=*)(!(userAccountControl:1.2.840.113556.1.4.803:=2)))` |
