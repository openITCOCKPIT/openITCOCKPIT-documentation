...
- SCORE Bereich Exklusiv (< 10 oder > 20 – außerhalb des Bereichs von 10 bis 20): Die Gesamtpunktzahl wird geprüft, ob sie außerhalb eines bestimmten Bereichs liegt. Damit alle Status berücksichtigt werden, sollten die Schwellwerte so gesetzt werden, dass die exklutierten Bereiche ineinander
verschachtelt liegen. Dabei hat der Unbekannt-Schwellwert den größten Bereich und der Warnung Schwellwert den kleinsten Bereich. Beispiel: Der Warnung-Schwellwert ist von 2 bis 3. Der Kritisch-Schwellwert ist von -2 bis 7 und der Unbekannt-Schwellwert ist von -5 bis 5. 
Ist die Gesamtpunktzahl 4 ist das Ergebnis Warnung, da 4 außerhalb des definierten Bereichs liegt.
